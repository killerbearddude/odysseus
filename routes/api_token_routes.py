...
MAX_NAME_LEN = 100
DEFAULT_SCOPES = "chat"
ALLOWED_SCOPES = ALL_API_SCOPES
# Scope validation is delegated to core.scopes so token issuance and
# route enforcement cannot drift apart as new scoped routes are added.
TOKEN_PROFILES = {
    "chat": ["chat"],
